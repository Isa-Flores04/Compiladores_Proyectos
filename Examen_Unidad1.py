...
def analizar_codigo():
    ...
    for tok in vocabulario.lexer:
        ...
        is_reserved = "Sí" if tok.type in Vocabulario.palabras_reservadas.values() else ""
        is_identificador = "Sí" if tok.type == 'IDENTIFICADOR' else ""
        is_numero = "Sí" if tok.type == 'NUMERO' else ""
        is_operador = "Sí" if tok.type == 'OPERADOR' else ""
        is_simbolo = "Sí" if tok.type == 'SIMBOLO' else ""
